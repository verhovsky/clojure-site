...
* Strings - Enclosed in "double quotes". May span multiple lines. Standard https://docs.oracle.com/javase/specs/jls/se7/html/jls-3.html#jls-3.10.6[Java escape characters] are supported.
